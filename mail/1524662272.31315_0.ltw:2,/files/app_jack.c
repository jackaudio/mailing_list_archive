	...
	struct jack_data *jack_data)
{
    ...
    ast_log(LOG_WARNING,"input_rb:%d",jack_data->input_rb);
	...
	struct jack_data *jack_data)
{
    ...
    ast_log(LOG_WARNING,"jack_data->output_rb:%d",jack_data->output_rb);
...
static int init_jack_data(struct ast_channel *chan, struct jack_data *jack_data)
{
	...
	*/
    ...
    ast_log(LOG_WARNING,"client name:%s<><><><><><><>server name:%s",jack_data->client,jack_data->server_name);
	...
	ast_log(LOG_WARNING,"input port :%s name:%s<><><><><>output port :%s name:%s\n",jack_data->input_port,jack_data->output_port,jack_port_name(jack_data->input_port),jack_port_name(jack_data->output_port));
...
ast_log(LOG_WARNING,"connect input port :%s name:%s<><><><><>connect output port :%s name:%s\n",jack_data->connect_input_port,jack_data->connect_output_port,jack_port_name(jack_data->connect_input_port),jack_port_name(jack_data->connect_output_port));
